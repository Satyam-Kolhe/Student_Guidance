    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          ...
          <Route
            path="/quiz"
            element={isLoggedIn ? <QuizComponent /> : <Navigate to="/" />}
          />
          <Route
            path="/recommendations"
            element={isLoggedIn ? <Recommendations /> : <Navigate to="/" />}
          />
          <Route
            path="/mentors"
            element={
              isLoggedIn ? <MentorRecommendations /> : <Navigate to="/" />
            }
          />
        </Routes>
...
function getCareerTraits(career) {
  const traits = {
    ...
    "Data Science":
      "analytical skills, statistical knowledge, and data interpretation",
